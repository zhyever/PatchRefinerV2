...
model=dict(
    ...
    config=dict(
        ...
        pretrained=None,
        # pretrained='work_dir/project_folder/plus/zoedepth/u4k/convx_ablation/pretrain_convx_m0s1_sch/checkpoint_96.pth',
...
#     optimizer=dict(type='AdamW', lr=0.00357, weight_decay=0.1),
...
#             'coarse_branch': dict(lr_mult=0.00336, decay_mult=0.1),
#         }))
