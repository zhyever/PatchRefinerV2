...
model=dict(
    ...
    config=dict(
        ...
        # pretrained=None,
        # pretrained='work_dir/project_folder/plus/zoedepth/u4k/mobile_ablation/pretrain_mobile_m0s1/checkpoint_96.pth',
        pretrained='./work_dir/project_folder/v2/zoedepth/u4k/mobile_ablation/pretrain_mobile_small_m0s1/checkpoint_96.pth',
