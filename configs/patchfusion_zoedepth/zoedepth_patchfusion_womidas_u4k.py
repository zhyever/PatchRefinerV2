...
zoe_depth_config=dict(
    ...
    pretrained_resource=None, # load with pretrain_model (no need to set here)
    use_pretrained_midas=True, # useless
    train_midas=True,
...
model=dict(
    ...
    config=dict(
        ...
        max_depth=max_depth,
        load_branch=True,
        pretrain_model=['./work_dir/pt_zoedepth/coarse_pretrain/checkpoint_24.pth', './work_dir/project_folder/zoedepth/u4k/pf_fine_pretrain_nomidas/checkpoint_24.pth'], # coarse, fine
...
train_cfg=dict(max_epochs=16, val_interval=2, save_checkpoint_interval=16, log_interval=100, train_log_img_interval=500, val_log_img_interval=6, val_type='epoch_base', eval_start=0)
