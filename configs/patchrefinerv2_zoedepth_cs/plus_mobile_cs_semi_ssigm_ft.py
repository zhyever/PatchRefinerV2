...
teacher_model=dict(
    ...
    config=dict(
        ...
        load_whole=True,
        pretrained='./work_dir/pr_zoedepth/u4k/patchrefiner/checkpoint_24.pth',
        pre_norm_bbox=True,
))
...
student_model=dict(
    ...
    config=dict(
        ...
        whole_pretrained='work_dir/project_folder/plus/zoedepth/cs/mobile_onlyrealdomain_cspretrain_alignlr/checkpoint_05.pth',
        pretrained=None,
))
...
optim_wrapper=dict(
    ...
    paramwise_cfg=dict(
        ...
        custom_keys={
            ...
            'student_model.coarse_branch': dict(lr_mult=0.1, decay_mult=1000),
        }))
