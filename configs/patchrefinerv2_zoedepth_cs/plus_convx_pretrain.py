    ...
    config=dict(
        ...
        refiner=dict(
            fine_branch=dict(
                ...
                with_decoder=False,
                encoder_channels=[96, 192, 384, 768, 1536], # convx -> [92, 384, 768, 1536], one additional conv from 192 to 96
        ...
        pretrained='./work_dir/project_folder/plus/zoedepth/cs/convx_pretrain/checkpoint_36.pth',
))
...
# train_cfg=dict(max_epochs=12, val_interval=2, save_checkpoint_interval=12, log_interval=100, train_log_img_interval=1000, val_log_img_interval=50, val_type='epoch_base', eval_start=0)
