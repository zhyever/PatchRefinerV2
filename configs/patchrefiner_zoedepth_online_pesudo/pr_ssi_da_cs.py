...
sub_model_student=dict(
    ...
    config=dict(
        ...
        pretrain_coarse_model='./work_dir/zoedepth/cityscapes/coarse_pretrain/checkpoint_05.pth', # will load the coarse model     
        ...
        load_whole=True,
        pretrained='./work_dir/zoedepth/cityscapes/pr/checkpoint_05.pth',
        pre_norm_bbox=True,
))
...
model_cfg_teacher=dict(
    ...
    config=dict(
        ...
        sigloss=dict(type='SILogLoss'),
        load_whole=True,
        pretrained='./work_dir/zoedepth/u4k/patchrefiner/checkpoint_24.pth',
        pre_norm_bbox=True,
))
...
model=dict(
    ...
    edge_loss_weight=1,
    edgeloss=dict(
        type='ScaleAndShiftInvariantDALoss',
