...
sub_model_student=dict(
    ...
    config=dict(
        ...
        pretrain_coarse_model='./work_dir/zoedepth/scannet/coarse_pretrain/checkpoint_05.pth', # will load the coarse model     
        ...
        load_whole=True,
        pretrained='./work_dir/zoedepth/scannet/pr/checkpoint_05.pth',
        pre_norm_bbox=True,
))
...
train_dataloader=dict(
    dataset=dict(
        pseudo_label_path='./work_dir/zoedepth/u4k/patchrefiner/generate_pls_scannet',
