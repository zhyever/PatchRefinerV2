...
zoe_depth_config=dict(
    ...
    pretrained_resource='local::/home/liz0l/shortcuts/monodepth3_checkpoints/ZoeDepthv1_16-Apr_12-07-9614edef0d28_latest.pt', # use torch2 version
...
model=dict(
    ...
    config=dict(
        ...
        # pretrain_coarse_model='/home/liz0l/shortcuts/monodepth3_checkpoints/ZoeDepthv1_16-Apr_12-07-9614edef0d28_latest.pt', # will load the coarse model
        pretrain_coarse_model='./work_dir/ZoeDepthv1_kitti.pth',  
...
collect_input_args=['image_lr', 'image_hr', 'crops_image_hr', 'crop_depths', 'bboxs', 'seg_image']
...
val_dataloader=dict(
    ...
    dataset=dict(
        type='KittiDataset',
        mode='infer',
        data_root='/ibex/ai/home/liz0l/codes/datasets/kitti_test/image',
        split='/ibex/ai/home/liz0l/codes/datasets/kitti_test/split_test.txt',
        min_depth=1e-3,
        max_depth=80,
        transform_cfg=dict(
            degree=1.0,
