...
model=dict(
    ...
    config=dict(
        ...
        pretrain_fine_model='./work_dir/project_folder/zoedepth/u4k/coarse_pretrain_nomidas/checkpoint_24.pth', # will load the fine model
        strategy_refiner_target='offset_coarse',
        
        coarse_branch=zoe_depth_config,
        refiner=dict(
            fine_branch=zoe_depth_refiner_config,
            fusion_model=dict(
                type='FusionUnet',
...
train_cfg=dict(max_epochs=36, val_interval=4, save_checkpoint_interval=36, log_interval=100, train_log_img_interval=500, val_log_img_interval=6, val_type='epoch_base', eval_start=0)
