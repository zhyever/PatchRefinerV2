...
model=dict(
    ...
    config=dict(
        ...
        pretrain_coarse_model='./work_dir/pr_zoedepth/scannet/coarse_pretrain/checkpoint_05.pth', # will load the coarse model     
...
# train_cfg=dict(max_epochs=10, val_interval=1, save_checkpoint_interval=10, log_interval=100, train_log_img_interval=1000, val_log_img_interval=50, val_type='epoch_base', eval_start=0)
train_cfg=dict(max_epochs=36, val_interval=6, save_checkpoint_interval=36, log_interval=100, train_log_img_interval=1000, val_log_img_interval=50, val_type='epoch_base', eval_start=0)
# train_cfg=dict(max_epochs=12, val_interval=6, save_checkpoint_interval=36, log_interval=100, train_log_img_interval=1000, val_log_img_interval=50, val_type='epoch_base', eval_start=0)
