...
model=dict(
    ...
    config=dict(
        ...
        pretrained='./work_dir/project_folder/plus/zoedepth/scannet/ap_eff/checkpoint_36.pth',
        # pretrained=None,
))
...
# train_cfg=dict(max_epochs=24, val_interval=2, save_checkpoint_interval=24, log_interval=100, train_log_img_interval=1000, val_log_img_interval=50, val_type='epoch_base', eval_start=0)
# train_cfg=dict(max_epochs=12, val_interval=2, save_checkpoint_interval=12, log_interval=100, train_log_img_interval=500, val_log_img_interval=6, val_type='epoch_base', eval_start=0)
train_cfg=dict(max_epochs=12, val_interval=2, save_checkpoint_interval=12, log_interval=100, train_log_img_interval=500, val_log_img_interval=6, val_type='epoch_base', eval_start=0)
